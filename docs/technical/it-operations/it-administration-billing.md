...
### SGSI - Sistema di Gestione Sicurezza Informazioni (ISMS)
<!-- graphify-evidence-id: 816550bd38b5 -->

- **Source**: `PSGSI POLITICA DELLA SICUREZZA DELLA INFORMAZIONI rev. 1 16.10.2025.md`
- **Graph community**: 4

| Emesso e verificato dal Responsabile del Sistema di Gestione della Sicurezza delle Informazioni (SGSI) | Emesso e verificato dal Responsabile del Sistema di Gestione della Sicurezza delle Inform

*Technology stack: to be enriched from source document.*

### Sistema di filtri categorie di siti
<!-- graphify-evidence-id: a060ca9a46ff -->
